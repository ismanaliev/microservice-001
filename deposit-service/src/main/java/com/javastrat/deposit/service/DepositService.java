package com.javastrat.deposit.service;
...
import com.javastrat.deposit.exception.DepositServiceException;
import com.javastrat.deposit.repository.DepositRepository;
import com.javastrat.deposit.rest.*;
...
public class DepositService {
    ...
    public DepositResponseDTO deposit(Long accountId, Long billId, BigDecimal amount) {
        ...
        if (billId != null) {
            ...
            depositRepository.save(new Deposit(amount, billId, OffsetDateTime.now(),
    ...
    private BillRequestDTO createBillRequest(BigDecimal amount, BillResponseDTO billResponseDTO) {
        ...
        billRequestDTO.setIsDefault(billResponseDTO.getOverdraftEnabled());
